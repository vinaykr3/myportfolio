    ...
    return <div className='pt-12' id='skills'>
        ...
        <main className='w-full px-6 py-8 md:flex md:flex-row '>
            <div className="left md:w-6/12 md:px-3 md:flex md:flex-col md:mt-12">
                ...
                <p className='py-6 text-center md:text-left md:pr-10 lg:pr-28 font-light text-gray-800'>I am learning web designing since 2020 and i am UX Designer UI Designing React Librarise, I gave myself enough time to learn front end development! And I'm learning over and over again!</p>
                <button className='w-2/3 md:w-1/2 hover:bg-blue-400 text-blue-600 hover:text-white rounded font-bold text-xl border-2 border-gray-700 py-2 cursor-not-allowed'>Read More</button>
            </div>
